    ...
    <FAQContext.Provider value={{ isFAQVisible, setIsFAQVisible }}>
      <nav
        className={cn(
          ...
          isScrolled
            ? "top-4 left-1/2 transform -translate-x-1/2 w-11/12 max-w-7xl bg-background/40 backdrop-blur-lg rounded-2xl shadow-[0px_8px_20px_-2px_rgba(31,31,31,0.3),4px_0px_12px_-2px_rgba(31,31,31,0.2),-4px_0px_12px_-2px_rgba(31,31,31,0.2)]"
