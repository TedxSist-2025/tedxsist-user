...
export default function CombinedScrollAnimation({
  ...
  description = "Scroll this component and see the animation come to life!",
  children,
}: {
  title?: string;
  description?: string;
  ...
  const pathLengths = [
    ...
    useTransform(scrollYProgress, [0.1, 0.85], [0, 1]),
    useTransform(scrollYProgress, [0.2, 0.9], [0, 1]),
    useTransform(scrollYProgress, [0.3, 0.95], [0, 1]),
    ...
    <div className="h-[80rem] relative" ref={containerRef}>
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center">
        <div className="w-full max-w-7xl mx-auto px-4">
          ...
          >
            <p className="text-4xl md:text-7xl font-bold pb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-400">
              {title}
            </p>
          ...
          <motion.div
            ...
            className="relative w-full h-[400px] bg-black/10 rounded-2xl p-4"
          >
            <svg
              width="100%"
              height="100%"
      ...
      {/* Content Section */}
      <div className="mt-[100vh] bg-neutral-950 min-h-screen">
        {children}
      </div>
    </div>
  );
