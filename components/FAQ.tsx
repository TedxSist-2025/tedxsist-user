        ...
        <div className="flex flex-col gap-16">
          ...
          <div className="text-center space-y-6">
            <div className="space-y-4">
              <Badge variant="outline" className="px-2 py-0.5 text-xs sm:text-sm font-medium uppercase tracking-wide rounded-full border-[#EB0028] text-[#EB0028]">
                FAQ
              </Badge>
            ...
            <div className="flex justify-center gap-4">
              <Button variant="outline" className="gap-2 hover:text-primary hover:bg-background focus:primary">
              ...
              {faqItems.map((item, index) => {
                ...
                return (
                  <AccordionItem key={index} value={`item-${index}`} className="border-b border-foreground">
                    <AccordionTrigger 
                      className="text-lg sm:text-xl font-semibold hover:no-underline focus:no-underline flex items-center gap-4 text-foreground"
